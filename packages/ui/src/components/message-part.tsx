...
export function UserMessageDisplay(props: { message: UserMessage; parts: PartType[]; actions?: UserActions; alwaysShowMessageMeta?: boolean }) {
  ...
  return (
    <div data-component="user-message" style={{ "--user-message-border-color": borderColor() }}>
          ...
          <Show when={path()}>
            ...
            >
              <div data-component="edit-content">
                <Dynamic component={fileComponent} mode="diff" diffStyle={wide() ? "split" : "unified"} {...fileCompProps()} />
              </div>
            </ToolFileAccordion>
          </Show>
