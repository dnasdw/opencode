...
function HomeSessionRow(props: {
  ...
  return (
    <div class="group/session relative flex min-h-10 min-w-0 items-center rounded-[6px]">
      <button
        type="button"
        data-component="home-session-row"
        class={`${HOME_ROW} min-h-10 min-w-0 flex-1 gap-2 py-3 pl-3 pr-10`}
